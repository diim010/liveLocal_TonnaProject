## Live-local - A minimalist WordPress starter theme
...
Live-local (or simply *Air*) is designed to be an ultra minimal starting point for a WordPress project at [Digitoimisto Dude Oy](https://www.dude.fi), a Finnish boutique digital agency in the center of Jyväskylä. Theme is originally based on [\_s](https://github.com/automattic/_s). We welcome all happy contributors with open arms!
...
Live-local can register your CPT:s automatically.
...
Live-local can register your Taxonomies automatically.
...
Live-local uses namespaced PHP since 5.0.0. This means that we no longer need to prefix functions and hooks, because `namespace Live_Local;` takes care of that.
...
Please refer to Wiki section [Getting started in theming with Live-local](https://github.com/digitoimistodude/air-light/wiki#2-getting-started-in-theming-with-air-light).
