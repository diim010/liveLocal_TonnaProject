 ...
 */
define( 'LIVE_LOCAL_VERSION', '9.5.0' );
...
add_action( 'after_setup_theme', function() {
  $theme_settings = [
     ...
     */
    'menu_locations' => [
      'primary' => __( 'Primary Menu', 'live-local' ),
    ],
     ...
     * https://github.com/digitoimistodude/live-local#custom-taxonomies
     */
    'taxonomies' => [
     ...
     *
     * See the instructions:
     * https://github.com/digitoimistodude/live-local#custom-post-types
     */
    'post_types' => [
      'Course_Post_Type',
      'Event_Post_Type',
    ...
    'acf_blocks' => [
      [
        'name'           => 'block-hero',
        'title'          => 'Hero Block',
        'description'    => 'Hero block with background image and text',
